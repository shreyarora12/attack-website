...
STIX enables organizations to share CTI with one another in a consistent and machine readable manner, allowing security communities to better understand what computer-based attacks actually are. They are most likely to see and to anticipate and/or respond to the attacks faster and more effectively.
